...
declare -A ICONS=(
  ...
  ["$TG/sidebar-show-symbolic_rotated.svg"]="$S_ICON:table_viewer.png"
  ...
  ["$DT/actions/go-up-symbolic.svg"]="$S_ICON:arrow_up.png"
  ["$DT/actions/go-down-symbolic.svg"]="$S_ICON:arrow_down.png"
  ...
  ["$DT/categories/preferences-other-symbolic.svg"]="$S_INFO:option_view.png"
  ...
  ["$DT/actions/help-about-symbolic.svg"]="$S_INFO:about_description.png"
