...
declare -A ICONS=(
  ...
  ["$DT/actions/edit-copy-symbolic.svg"]="$S_ICON:edit_copy.png $S_ICON:measure_copy.png $S_ICON:track_clone.png"
  ["$DT/actions/edit-paste-symbolic.svg"]="$S_ICON:edit_paste.png $S_ICON:measure_paste.png"
  ["$DT/actions/edit-clear-symbolic.svg"]="$S_ICON:measure_clean.png"
  ...
  ["$DT/actions/list-add-symbolic.svg"]="$S_ICON:list_add.png $S_ICON:track_add.png $S_ICON:measure_add.png"
  ["$DT/actions/list-remove-symbolic.svg"]="$S_ICON:list_remove.png $S_ICON:track_remove.png $S_ICON:measure_remove.png 14x14:mute-disabled.png 14x14:mute-disabled-dim.png 14x14:solo-disabled.png 14x14:solo-disabled-dim.png"
  ...
  ["$TG/media-playlist-repeat-song-symbolic_start.svg"]="$S_ICON:transport_loop_start.png"
  ["$TG/media-playlist-repeat-song-symbolic_end.svg"]="$S_ICON:transport_loop_end.png"
  ...
  ["$DT/actions/go-first-symbolic.svg"]="$S_ICON:marker_first.png $S_ICON:measure_first.png"
  ["$DT/actions/go-previous-symbolic.svg"]="$S_ICON:marker_previous.png $S_ICON:measure_previous.png $S_ICON:browser_back.png $S_ICON:arrow_left.png"
  ["$DT/actions/go-next-symbolic.svg"]="$S_ICON:marker_next.png $S_ICON:measure_next.png $S_ICON:arrow_right.png"
  ["$DT/actions/go-last-symbolic.svg"]="$S_ICON:marker_last.png $S_ICON:measure_last.png"
  ...
  ["$DT/actions/view-grid-symbolic.svg"]="$S_ICON:matrix.png"
  ["$TG/sidebar-show-symbolic_piano.svg"]="$S_ICON:piano.png"
  ["$DT/mimetypes/audio-x-generic-symbolic.svg"]="$S_ICON:browser_file.png"
  ["$DT/places/folder-symbolic.svg"]="$S_ICON:browser_folder.png"
  ["$DT/places/folder-remote-symbolic.svg"]="$S_ICON:browser_folder_remote.png"
  ["$DT/places/folder-music-symbolic.svg"]="$S_ICON:browser_collection.png"
