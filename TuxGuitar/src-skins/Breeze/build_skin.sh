...
declare -A ICONS=(
  ...
  ["$DT/actions/16/edit-select.svg"]="$S_ICON:edit_mode_selection.png"
  ...
  ["$DT/actions/16/configure.svg"]="$S_ICON:settings.png"
  ["$DT/actions/16/document-new.svg"]="$S_ICON:new.png"
  ["$DT/actions/16/document-open.svg"]="$S_ICON:open.png"
  ["$DT/actions/16/document-close.svg"]="$S_ICON:close.png"
  ["$DT/actions/16/document-save.svg"]="$S_ICON:save.png"
  ["$DT/actions/16/document-save-as.svg"]="$S_ICON:save-as.png"
  ["$DT/actions/16/document-import.svg"]="$S_ICON:import.png"
  ["$DT/actions/16/document-export.svg"]="$S_ICON:export.png"
  ["$DT/actions/16/document-print.svg"]="$S_ICON:print.png"
  ["$DT/actions/16/document-preview-archive.svg"]="$S_ICON:print-preview.png"
  ["$DT/actions/16/document-open-recent.svg"]="$S_ICON:history.png"
  ["$DT/actions/16/application-exit.svg"]="$S_ICON:exit.png"
  ["$DT/actions/16/edit-cut.svg"]="$S_ICON:edit_cut.png"
  ["$DT/actions/16/edit-copy.svg"]="$S_ICON:edit_copy.png $S_ICON:measure_copy.png $S_ICON:track_clone.png"
  ["$DT/actions/16/edit-paste.svg"]="$S_ICON:edit_paste.png $S_ICON:measure_paste.png"
  ["$DT/actions/16/edit-clear.svg"]="$S_ICON:measure_clean.png"
  ["$DT/actions/16/special_paste.svg"]="$S_ICON:edit_repeat.png"
  ["$DT/actions/16/edit-undo.svg"]="$S_ICON:edit_undo.png"
  ["$DT/actions/16/edit-redo.svg"]="$S_ICON:edit_redo.png"
  ["$DT/actions/16/document-properties.svg"]="$S_ICON:song_properties.png"
  ["$DT/actions/16/zoom-in.svg"]="$S_ICON:zoom_in.png"
  ["$DT/actions/16/zoom-original.svg"]="$S_ICON:zoom_original.png"
  ["$DT/actions/16/zoom-out.svg"]="$S_ICON:zoom_out.png"
  ["$DT/actions/16/list-add.svg"]="$S_ICON:list_add.png $S_ICON:track_add.png $S_ICON:measure_add.png"
  ...
  ["$DT/status/16/audio-volume-muted.svg"]="$S_ICON:track_mute.png 14x14:mute.png 14x14:mute-dim.png"
  ["$DT/actions/16/document-edit.svg"]="$S_ICON:list_edit.png $S_ICON:edit_mode_edition.png"
  ["$DT/actions/16/go-down-skip.svg"]="$S_ICON:list_move_up.png"
  ["$DT/actions/16/go-up-skip.svg"]="$S_ICON:list_move_down.png"
  ["$TG/sidebar-expand-left_top.svg"]="$S_ICON:toolbar_main.png"
  ["$DT/actions/16/sidebar-expand-left.svg"]="$S_ICON:toolbar_edit.png"
  ["$TG/sidebar-expand-left_bottom.svg"]="$S_ICON:table_viewer.png"
  ["$DT/devices/16/multimedia-player-ipod-mini-blue.svg"]="$S_ICON:transport.png"
  ["$DT/actions/16/media-playback-start.svg"]="$S_ICON:transport_play_1.png $S_ICON:transport_play_2.png $S_ICON:transport_icon_play_1.png $S_ICON:transport_icon_play_2.png"
  ["$DT/actions/16/media-playback-pause.svg"]="$S_ICON:transport_pause.png $S_ICON:transport_icon_pause.png"
  ["$DT/actions/16/media-playback-stop.svg"]="$S_ICON:transport_stop_1.png $S_ICON:transport_stop_2.png $S_ICON:transport_icon_stop_1.png $S_ICON:transport_icon_stop_2.png"
  ["$DT/actions/16/media-seek-forward.svg"]="$S_ICON:transport_next_1.png $S_ICON:transport_next_2.png $S_ICON:transport_icon_next_1.png $S_ICON:transport_icon_next_2.png"
  ["$DT/actions/16/media-seek-backward.svg"]="$S_ICON:transport_previous_1.png $S_ICON:transport_previous_2.png $S_ICON:transport_icon_previous_1.png $S_ICON:transport_icon_previous_2.png"
  ["$DT/actions/16/media-skip-backward.svg"]="$S_ICON:transport_first_1.png $S_ICON:transport_first_2.png $S_ICON:transport_icon_first_1.png $S_ICON:transport_icon_first_2.png"
  ["$DT/actions/16/media-skip-forward.svg"]="$S_ICON:transport_last_1.png $S_ICON:transport_last_2.png $S_ICON:transport_icon_last_1.png $S_ICON:transport_icon_last_2.png"
  ["$DT/actions/16/media-playlist-repeat.svg"]="$S_ICON:transport_mode.png"
  ...
  ["$DT/actions/16/bookmark-new.svg"]="$S_ICON:marker_add.png"
  ["$DT/actions/16/bookmarks.svg"]="$S_ICON:marker_list.png $S_ICON:marker.png"
  ["$DT/actions/16/go-top.svg"]="$S_ICON:track_first.png"
  ["$DT/actions/16/go-bottom.svg"]="$S_ICON:track_last.png"
  ["$DT/actions/16/go-up.svg"]="$S_ICON:track_previous.png $S_ICON:arrow_up.png"
  ["$DT/actions/16/go-down.svg"]="$S_ICON:track_next.png $S_ICON:arrow_down.png"
  ["$DT/actions/16/go-first.svg"]="$S_ICON:marker_first.png $S_ICON:measure_first.png"
  ["$DT/actions/16/go-previous.svg"]="$S_ICON:marker_previous.png $S_ICON:measure_previous.png $S_ICON:browser_back.png $S_ICON:arrow_left.png"
  ["$DT/actions/16/go-next.svg"]="$S_ICON:marker_next.png $S_ICON:measure_next.png $S_ICON:arrow_right.png"
  ["$DT/actions/16/go-last.svg"]="$S_ICON:marker_last.png $S_ICON:measure_last.png"
  ["$DT/preferences/22/preferences-other.svg"]="$S_INFO:option_view.png"
  ["$DT/actions/16/run-build-configure.svg"]="$S_ICON:tools_settings.png"
  ["$DT/actions/16/plugins.svg"]="$S_ICON:tools_plugins.png"
  ["$DT/devices/16/input-keyboard.svg"]="$S_ICON:tools_shortcuts.png"
  ...
  ["$DT/actions/16/folder-new.svg"]="$S_ICON:browser_new.png"
  ["$DT/actions/16/go-home.svg"]="$S_ICON:browser_root.png"
  ["$DT/actions/16/view-refresh.svg"]="$S_ICON:browser_refresh.png"
  ["$DT/actions/16/view-grid.svg"]="$S_ICON:matrix.png"
  ["$TG/dashboard-show_piano.svg"]="$S_ICON:piano.png"
  ["$DT/mimetypes/16/audio-x-generic.svg"]="$S_ICON:browser_file.png"
  ["$DT/places/16/folder.svg"]="$S_ICON:browser_folder.png"
  ["$DT/actions/16/document-open-remote.svg"]="$S_ICON:browser_folder_remote.png"
  ["$DT/places/16/folder-sound.svg"]="$S_ICON:browser_collection.png"
