...
declare -A ICONS=(
  ...
  ["$DT/devices/22/audio-headphones.svg"]="14x14:solo.png 14x14:solo-dim.png"
  ["$DT/status/16/audio-volume-muted.svg"]="14x14:mute.png 14x14:mute-dim.png"
  ...
  ["$TG/sidebar-expand-left_rotated.svg"]="$S_ICON:table_viewer.png"
  ...
  ["$DT/actions/22/help-about.svg"]="$S_INFO:about_description.png"
