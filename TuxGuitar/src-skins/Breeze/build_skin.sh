...
declare -A ICONS=(
  ...
  ["$DT/actions/16/edit-copy.svg"]="$S_ICON:edit_copy.png"
  ["$DT/actions/16/edit-paste.svg"]="$S_ICON:edit_paste.png"
  ...
  ["$DT/actions/16/list-add.svg"]="$S_ICON:list_add.png $S_ICON:track_add.png"
  ["$DT/actions/22/list-remove.svg"]="$S_ICON:list_remove.png $S_ICON:track_remove.png 14x14:mute-disabled.png 14x14:mute-disabled-dim.png 14x14:solo-disabled.png 14x14:solo-disabled-dim.png"
  ...
  ["$DT/actions/16/go-first.svg"]="$S_ICON:marker_first.png"
  ["$DT/actions/16/go-previous.svg"]="$S_ICON:marker_previous.png $S_ICON:browser_back.png $S_ICON:arrow_left.png"
  ["$DT/actions/16/go-next.svg"]="$S_ICON:marker_next.png $S_ICON:arrow_right.png"
  ["$DT/actions/16/go-last.svg"]="$S_ICON:marker_last.png"
