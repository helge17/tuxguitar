...
declare -A ICONS=(
  ...
  ["$TG/continuous_scrolling.svg"]="$S_ICON:continuous_scrolling.png"
  ...
  ["$TG/tempoindicator.svg"]="$S_ICON:tempoindicator.png"
  ...
  ["$TG/transport_time_counter.svg"]="$S_ICON:transport_time_counter.png"
