...
public class TGGoPageDownAction extends TGActionBase {

	public static final String NAME = "action.caret.go-page-down";

	public TGGoPageDownAction(TGContext context) {
		super(context, NAME);
	}
