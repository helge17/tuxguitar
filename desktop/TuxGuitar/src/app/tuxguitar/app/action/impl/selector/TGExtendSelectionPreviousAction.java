...
public class TGExtendSelectionPreviousAction extends TGActionBase {

	public static final String NAME = "action.selection.extend-previous";

	public TGExtendSelectionPreviousAction(TGContext context) {
		super(context, NAME);
	}
	...
	protected void processAction(TGActionContext context) {
		...
		tgActionManager.execute(TGGoPreviousMeasureAction.NAME, context);
