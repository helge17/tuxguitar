...
public class TGOpenStrokeDownDialogAction extends TGActionBase{

	public static final String NAME = "action.gui.open-stroke-down-dialog";

	public TGOpenStrokeDownDialogAction(TGContext context) {
		super(context, NAME);
	}
	...
	protected void processAction(TGActionContext tgActionContext){
		...
		if (!track.isPercussion()) {
			...
			tgActionContext.setAttribute(TGChangeStrokeAction.ATTRIBUTE_STROKE_DIRECTION, TGStroke.STROKE_DOWN);
