...
public class TEFileMetadata {
    ...
    private boolean graceNotesShowMusicalSymbols;
    ...
    public TEFileMetadata(int majorVersion, int minorVersion, int revision, int initialBpm, int toneChorus, int toneReverb, TEFileMetadataSyncopation syncopation,
    boolean graceNotesShowMusicalSymbols, boolean hasTextEvents, boolean hasChords, boolean hasCopyright, boolean hasReadingList, boolean hasUrl) {
        ...
        this.graceNotesShowMusicalSymbols = graceNotesShowMusicalSymbols;
    ...
    public boolean getGraceNoteShowMusicalSymbols() {
        return this.graceNotesShowMusicalSymbols;
    }
