...
import swtimpl.event.SWTDisposeListenerManager;
import swtimpl.event.SWTFocusListenerManager;
import swtimpl.event.SWTKeyListenerManager;
import swtimpl.event.SWTMouseDragListenerManager;
import swtimpl.event.SWTMouseListenerManager;
import swtimpl.event.SWTMouseMoveListenerManager;
import swtimpl.event.SWTMouseTrackListenerManager;
import swtimpl.event.SWTMouseWheelListenerManager;
import swtimpl.event.SWTResizeListenerManager;
import swtimpl.menu.SWTMenu;
import swtimpl.resource.SWTColor;
import swtimpl.resource.SWTCursor;
import swtimpl.resource.SWTFont;
