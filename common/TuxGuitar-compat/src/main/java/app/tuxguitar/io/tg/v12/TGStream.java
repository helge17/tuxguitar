package app.tuxguitar.io.tg.v12;
...
public class TGStream {
	...
	public static final int EFFECT_BEND = 0x000001;

	public static final int EFFECT_TREMOLO_BAR = 0x000002;

	public static final int EFFECT_HARMONIC = 0x000004;

	public static final int EFFECT_GRACE = 0x000008;

	public static final int EFFECT_TRILL = 0x000010;

	public static final int EFFECT_TREMOLO_PICKING = 0x000020;

	public static final int EFFECT_VIBRATO = 0x000040;

	public static final int EFFECT_DEAD = 0x000080;

	public static final int EFFECT_SLIDE = 0x000100;

	public static final int EFFECT_HAMMER = 0x000200;

	public static final int EFFECT_GHOST = 0x000400;

	public static final int EFFECT_ACCENTUATED = 0x000800;

	public static final int EFFECT_HEAVY_ACCENTUATED = 0x001000;

	public static final int EFFECT_PALM_MUTE = 0x002000;

	public static final int EFFECT_STACCATO = 0x004000;

	public static final int EFFECT_TAPPING = 0x008000;
	...
	public static final int EFFECT_LET_RING = 0x080000;
