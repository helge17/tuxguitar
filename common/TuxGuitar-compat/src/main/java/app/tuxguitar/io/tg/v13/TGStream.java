package org.herac.tuxguitar.io.tg.v13;
...
public class TGStream {
	...
	public static final TGFileFormat TG_FORMAT = new TGFileFormat("TuxGuitar 1.3", "application/x-tuxguitar", new String[]{ TG_FORMAT_CODE });
