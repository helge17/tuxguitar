...
public class TGStream {
	...
	public static final String TG_FORMAT_VERSION = (TG_FORMAT_NAME + " - " + new TGVersion(1,2,20111001).getVersion() );
	
	public static final String TG_FORMAT_CODE = ("tg");
	
	public static final TGFileFormat TG_FORMAT = new TGFileFormat("TuxGuitar 1.2.2", "audio/x-tuxguitar", new String[]{ TG_FORMAT_CODE });
