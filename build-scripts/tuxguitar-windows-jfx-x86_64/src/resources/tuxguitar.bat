...
SET "JAVA_CLASSPATH=%JAVA_CLASSPATH%;lib\tuxguitar-ui-toolkit-jfx.jar"
...
SET "JAVA_CLASSPATH=%JAVA_CLASSPATH%;lib\javafx-base.jar"
SET "JAVA_CLASSPATH=%JAVA_CLASSPATH%;lib\javafx-controls.jar"
SET "JAVA_CLASSPATH=%JAVA_CLASSPATH%;lib\javafx-graphics.jar"
