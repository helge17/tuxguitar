...
public class VSTFocusEffectUICommand extends TGAbstractCommand<Void> {
	
	public static final Integer COMMAND_ID = 25;
	
	public VSTFocusEffectUICommand(TGConnection connection) {
		super(connection);
	}
