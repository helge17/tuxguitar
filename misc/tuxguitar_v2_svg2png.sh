...
inkscape $SPLASH --export-filename=desktop/build-scripts/common-resources/common-windows-installer-icons/TG_logo_163x314.png --export-type=png --export-background-opacity=1 --export-height=314
gm mogrify -shave 55x0 -crop 163x314 desktop/build-scripts/common-resources/common-windows-installer-icons/TG_logo_163x314.png
