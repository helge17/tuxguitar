...
public class AudioFileFormat {
     ...
     * @param byteLength the length of the file in bytes, or <code>MediaSystem.NOT_SPECIFIED</code>
     * @param format the format of the audio data contained in the file
     * @param frameLength the audio data length in sample frames, or <code>MediaSystem.NOT_SPECIFIED</code>
     *
     * @see #getType
     */
     ...
     *                    <code>MediaSystem.NOT_SPECIFIED</code>
