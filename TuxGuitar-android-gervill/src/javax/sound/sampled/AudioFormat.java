...
public class AudioFormat {
     ...
     * MediaSystem.isConversionSupported}) or capabilities (e.g. {@link
     * DataLine.Info#getFormats() DataLine.Info.getFormats}), a sample rate of
     * <code>MediaSystem.NOT_SPECIFIED</code> means that any sample rate is
     * acceptable. <code>MediaSystem.NOT_SPECIFIED</code> is also returned when
     * the sample rate is not defined for this audio format.
     * @return the number of samples per second,
     * or <code>MediaSystem.NOT_SPECIFIED</code>
     *
     * @see #getFrameRate()
     ...
     * <code>MediaSystem.NOT_SPECIFIED</code> means that any sample size is
     * acceptable. <code>MediaSystem.NOT_SPECIFIED</code> is also returned when
     ...
     * <code>MediaSystem.NOT_SPECIFIED</code> means that any (positive) number of channels is
     * acceptable.
     ...
     * <code>MediaSystem.NOT_SPECIFIED</code> means that any frame size is
     * acceptable. <code>MediaSystem.NOT_SPECIFIED</code> is also returned when
     ...
     * <code>MediaSystem.NOT_SPECIFIED</code> means that any frame rate is
     * acceptable. <code>MediaSystem.NOT_SPECIFIED</code> is also returned when
     ...
     * {@code MediaSystem.NOT_SPECIFIED}.
