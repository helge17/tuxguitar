...
public interface Line /*extends AutoCloseable */ {
     ...
     * the <code>Line</code>, <code>Mixer</code>, and <code>MediaSystem</code>
     ...
     * @see AudioSystem#getLine <code>MediaSystem.getLine(Line.Info)</code>
     * @see AudioSystem#getSourceLineInfo <code>MediaSystem.getSourceLineInfo(Line.Info)</code>
     * @see AudioSystem#getTargetLineInfo <code>MediaSystem.getTargetLineInfo(Line.Info)</code>
     * @see AudioSystem#isLineSupported <code>MediaSystem.isLineSupported(Line.Info)</code>
     * @since 1.3
     */
