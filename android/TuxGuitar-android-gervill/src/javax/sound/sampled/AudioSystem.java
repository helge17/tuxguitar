 ...
 * <code>MediaSystem</code> without dealing explicitly
 * with mixers.
 *
...
//
//
//    //$$fb 2002-11-26: fix for 4757930: DOC: MediaSystem.getTarget/SourceLineInfo() is ambiguous
//    /**
...
//
     ...
     * For details, refer to the {@link MediaSystem class description}.
     *
...
//                                             MediaSystem.NOT_SPECIFIED,
//                                             16, 2, 4,
//                                             MediaSystem.NOT_SPECIFIED, true);
//        DataLine.Info info = new DataLine.Info(Clip.class, format);
//        return (Clip) MediaSystem.getLine(info);
//    }
//
//
//    /**
...
//                                             MediaSystem.NOT_SPECIFIED, true);
//        DataLine.Info info = new DataLine.Info(Clip.class, format);
//        Mixer mixer = MediaSystem.getMixer(mixerInfo);
...
//     * the audio file type is <code>MediaSystem.NOT_SPECIFIED</code>.
//     *
...
//
    ...
    private static List getProviders(Class providerClass) {
        return ServiceProvider.getProviders(providerClass);
    }
}
